...
describe("Apple format", () => {
  ...
  it("Parse incoming text for trusted roots", async () => {
    ...
    const tl = await apple.getTrusted(appleTLListText, appleCertListText, appleEVRootText, true);
  ...
  it("Parse incoming text for disallowed roots", async () => {
    ...
    let tl = await apple.getDisallowed(appleTLListText, appleCertListText, true);
